...
const AddItem = ({ isOpen, onClose, selectedBrand, onItemAdded, authConfig }) => {
  ...
  const handleAddItem = async (e) => {
    ...
    try {
      ...
      await axios.post("http://localhost:8080/item/add", itemData, authConfig);
      ...
      Swal.fire({
        icon: "error",
        title: "Error",
        text: error.response?.data || "Failed to add item",
      });
    }
  }; 
